...
// Fetch initial archetypes
const fetchInitialArchetypes = async () => {
  const initialArchetypes = await archetypeStore.fetchAutocompleteSelectArchetypes();
  archetypes.value = initialArchetypes;
};
