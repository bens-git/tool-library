...
export default function useApi() {
    ...
    const apiHost = import.meta.env.VITE_DEV_SERVER_URL;

    const baseApiURL = `${apiHost}/api`;

    const baseWebURL = `http://${apiHost}`;
    ...
    return { handleRequest, fetchRequest, sendRequest };
}
