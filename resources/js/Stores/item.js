...
export const useItemStore = defineStore('item', () => {
    ...
    const indexItemUnavailableDates = async (itemId) => {
    ...
    const indexItemRentedDates = async (itemId) => {
        const { fetchRequest } = useApi();
    ...
    const bookRental = async (itemId, startDate, endDate) => {
        const { sendRequest } = useApi();
    ...
    const addMyItemImage = async (itemId, image) => {
        const { sendRequest } = useApi();
    ...
    const updateItemAvailability = async (itemId, itemUnavailableDates, makeItemUnavailable) => {
        const { sendRequest } = useApi();
    ...
    return {
        destroy,
        indexItemUnavailableDates,
        indexItemRentedDates,
        bookRental,
        show,
        resetFilters,
        fetchItemById,
