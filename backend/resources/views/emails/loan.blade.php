...
<body>
    <p>Hello {{ $item->owner->discord_username }},</p>
    ...
    <p><b> Contact the renter, {{ $rental->renter->discord_username}}, on <a href='https://discord.gg/sFqqtaVu'>Discord</a> to arrange the exact location!</b></p>
